...
final class CharTreeTest extends TestCase
{
     ...
     */
    public function testCannotGetTreeTrimmedToNegativeLength(): void
    {
        $charTree = CharTree::fromArray([
            CharTree::fromString('ab'),
            CharTree::fromString('ac'),
        ...
        $charTree->getTreeTrimmedToLength(-5);
    }
     ...
     * @covers ::getTreeTrimmedToLength
     */
    public function testCanGetTreeTrimmedToPositiveLength(): void
    {
        $charTree = CharTree::fromArray([
            CharTree::fromString('a'),
            CharTree::fromString('ab'),
        ...
        ]), $charTree->getTreeTrimmedToLength(2));
    }
